  ...
  return (
    <nav className='sticky top-0 bg-white flex text-black text-bold opacity-100  min-w-full bg-white-600 pb-6 pt-4 px-10 shadow-md z-40 '>
        ...
        <div className='flex flex-col md:flex-row my-4 md:my-0 md:mx-10 h-fit md:relative md:top-8 w-full'>
            <p className='text-lg h-fit mx-3 cursor-pointer min-w-fit hover:scale-105 hover:text-green-950' onClick={() => navigate("/products/new")}>New in</p>
            <p className='text-lg h-fit mx-3 cursor-pointer min-w-fit hover:scale-105 hover:text-green-950' onClick={() => navigate("/products/bestsellers")}>Bestsellers</p>
            <p className='text-lg h-fit mx-3 cursor-pointer min-w-fit hover:scale-105 hover:text-green-950' onClick={() => navigate("/products/weekend")}>Weekend Boot</p>
            <p className='text-lg h-fit mx-3 cursor-pointer min-w-fit hover:scale-105 hover:text-green-950' onClick={() => navigate("/products/terrus")}>Terrus Clog</p>
            <p className='text-lg h-fit mx-3 cursor-pointer min-w-fit hover:scale-105 hover:text-green-950' onClick={() => navigate("/products/all")}>Shop all</p>
        </div>
